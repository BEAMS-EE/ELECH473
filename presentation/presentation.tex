...
\includegraphics[height=1.1cm, origin=c]{figures/ulbquadri_mini.pdf} ~~ \includegraphics[height=1cm, origin=c]{figures/beamsWODept.pdf} ~~\raisebox{-2mm}{} %\includegraphics[height=0.75cm]{ee_Xlarge.png}
