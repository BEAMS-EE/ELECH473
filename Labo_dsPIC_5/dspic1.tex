...
\item Make the line numbers appear in the C source (right-click on window->Properties->C File Type ->line numbers)
...
\Q{The code defines a global variable \kw{glob1}. Where is it defined? initialised? %REM: A \kw{global} cannot be initialized in its declaration. % why ???
}{}
